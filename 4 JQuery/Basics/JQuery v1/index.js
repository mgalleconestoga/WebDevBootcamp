...
console.log($("h1").css("color"));  // css() methos with one argument is a getter(), with two arguments it is a setter()
//$("h1").addClass("myClass");
...
$("h1").on("click", function() { alert("You clicked on Hello"); });     // example with anonymous function
